...
if __name__ == '__main__':
    ...
    successWin = tk.Tk()
    successWin.title("Connection")
    successWin.geometry("400x200")
    msgLabel = tk.Label(
        successWin, text="It's server\nSuccessfully connect to " + str((Dest_ip, Dest_port)))
    okBtn = tk.Button(successWin, text="OK", command=successWin.destroy)
    msgLabel.pack()
    okBtn.pack()
